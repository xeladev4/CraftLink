  ...
  return (
    <main className="w-screen min-h-screen overflow-x-hidden bg-[#333333] text-white">
      ...
      <HeroSection
        ...
        description="We're not just another marketplace — we're a platform built to empower skilled artisans and make hiring easier for clients."
        imageSrc="/feature.svg"
