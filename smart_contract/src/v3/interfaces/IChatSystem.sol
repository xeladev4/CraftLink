...
interface IChatSystem {
    ...
    function startConversation(address _user, bytes32 _conversationId, bytes32 _databaseId, bytes32 _initialRootHash)
        external;
    ...
    function isConversationActive(bytes32 _conversationId) external view returns (bool);
}
